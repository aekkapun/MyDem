...
/**
 * PermitCarSearch represents the model behind the search form about `backend\modules\car\models\PermitCar`.
 */
class PermitCarSearch extends PermitCar
{
    /**
     * @inheritdoc
     */
