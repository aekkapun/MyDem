...
/**
 * CarMasterSearch represents the model behind the search form about `backend\modules\vehicle\models\CarMaster`.
 */
class CarMasterSearch extends CarMaster
{
    /**
     * @inheritdoc
     */
